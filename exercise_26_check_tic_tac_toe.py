...
This exercise is challenging, but doable with only lists (of lists)!
Lists of lists are nearly the same as lists, just a bit trickier.
Remember that to get the first element in a list called my_list = [5, 10, 15], you index it with a variable like so:
...
The cool part is that you can use double-indexing to read the elements
