...
from the number 0. The first element in a list is “number 0”,
the second is “number 1”, etc.

As a result, when you want to get single elements out of a list,
you can ask a list for that number element:
...
You can also include a third number in the indexing,
...
or you can also use [:] at the end of the variable name (in the above examples, a[:]).
Strings are lists
...
szoveg=input("Adjon meg egy testszőlges szót! ")
if szoveg==szoveg[::-1]:
    print ("Palindrom. (oda, vissza olvasva ugyanaz...)")
else:
    print("Nem palindrom.")
    print (szoveg)
    print(szoveg[::-1])